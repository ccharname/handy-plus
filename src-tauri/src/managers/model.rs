...
#[derive(Debug, Clone, Serialize, Deserialize, Type)]
pub enum EngineType {
    /// transcribe-rs ONNX path for SenseVoice (chinese_balanced preset).
    SenseVoice,
...
impl ModelManager {
    pub fn new(app_handle: &AppHandle) -> Result<Self> {
        ...
        // --- dead engine model registrations removed (Whisper/Parakeet/Moonshine/GigaAM/Canary/Cohere/Sherpa/AppleSpeech) ---
